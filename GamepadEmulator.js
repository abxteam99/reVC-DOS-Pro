...
class GamepadEmulator {
            ...
            if (config.type === ControlType.onOff) {
                const onPointerDown = (e) => {
                    ...
                    if (config.lockTargetWhilePressed) {
                        try {
                            if (tapTarget && tapTarget.setPointerCapture) {
                        ...
                        try {
                            if (tapTarget && tapTarget.releasePointerCapture) {
    ...
    AddDragControlListener(config, callback) {
        ...
        const onPointerDown = (e) => {
            ...
            if (config.lockTargetWhilePressed) {
                try {
                    if (config.tapTarget && config.tapTarget.setPointerCapture) {
                ...
                try {
                    if (config.tapTarget && config.tapTarget.releasePointerCapture) {
